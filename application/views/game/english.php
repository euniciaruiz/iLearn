    ...
    <div id="page-wrapper">
      <div id="absolute-wrapper">
        ...
        <div class="rectangle rectangle-4">
          ...
          <button class="btn btn-5" value="<?php echo $english[$rand][1][3]; ?>"><?php echo $english[$rand][1][3]; ?></button>
        ...
        <img src="<?php echo base_url();?>images/language_alphabet1.jpg" class="image image-7">
        <img src="<?php echo base_url();?>images/images-3.jpg" class="image image-8">
