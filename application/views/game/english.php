...
<body>
    <div id="page-wrapper">
      <div id="absolute-wrapper">
        ...
        <img src="<?php echo base_url();?>images/language_alphabet1.jpg" class="image image-4">
        ...
        <div class="paragraph paragraph-7 paragraph-9">
          <p>Lives: <?php echo $lives;?></p>        </div>
        <?php $rand = array_rand($english); ?>
        <div class="hero-unit hero-unit-2">
          <p><?php echo $english[$rand][0]; ?></p>
          <div class="btns"></div>
        </div>
        <img src="<?php echo base_url();?>images/images-3.jpg" class="image image-5">
        <button class="btn btn-1 btn-2 btn-4"  value="<?php echo $english[$rand][1][0]; ?>"><?php echo $english[$rand][1][0]; ?></button>
        <button class="btn btn-1 btn-5" value="<?php echo $english[$rand][1][1]; ?>"><?php echo $english[$rand][1][1]; ?></button>
        <button class="btn btn-3 btn-6" value="<?php echo $english[$rand][1][2]; ?>"><?php echo $english[$rand][1][2]; ?></button>
        <button class="btn btn-2 btn-3" value="<?php echo $english[$rand][1][3]; ?>"><?php echo $english[$rand][1][3]; ?></button>
        <div class="rectangle rectangle-2"></div>
      </div>
    </div>       
		
		<script>
			var correctAnswer = '<?php echo $english[$rand][2]; ?>';
