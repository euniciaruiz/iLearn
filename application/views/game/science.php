    ...
    <div id="page-wrapper">
      <div id="absolute-wrapper">
        ...
        <div class="rectangle rectangle-4">
	      ...
	      <button class="btn btn-5" value="<?php echo $science[$rand][1][3]; ?>"><?php echo $science[$rand][1][3]; ?></button>
        </div>
        ...
        <img src="<?php echo base_url();?>images/icontelescope.jpg" class="image image-1">
        <div class="rectangle rectangle-1 rectangle-2 rectangle-6">
          <div class="paragraph">
            <p>Copyright @</p>
          </div>
        </div>
        <img src="<?php echo base_url();?>images/workinginalaboratory-1.gif" class="image image-2">
      </div>
    </div>
    <script>
