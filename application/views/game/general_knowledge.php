  ...
  <body>
    <div id="page-wrapper">
      <div id="absolute-wrapper">
        <img src="<?php echo base_url();?>images/earth.jpg" class="image image-3">
        <img src="<?php echo base_url();?>images/movies.jpg" class="image image-4">
        ...
        <button class="btn btn-1 btn-2" value="<?php echo $general_knowledge[$rand][1][0]; ?>"><?php echo $general_knowledge[$rand][1][0]; ?></button>
	      ...
	      <button class="btn btn-5" value="<?php echo $general_knowledge[$rand][1][3]; ?>"><?php echo $general_knowledge[$rand][1][3]; ?></button> 
        </div>
        ...
        <img src="<?php echo base_url();?>images/images-4.jpg" class="image image-5">
